...
public class Enum_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_78un91_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createProperty_78un91_a0(editorContext, node));
    return editorCell;
  }

  private EditorCell createProperty_78un91_a0(EditorContext editorContext, SNode node) {
