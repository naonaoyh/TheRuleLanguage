...
public class Condition_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_2lgv54_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_2lgv54_a0(editorContext, node));
    return editorCell;
  }

  private EditorCell createRefNode_2lgv54_a0(EditorContext editorContext, SNode node) {
