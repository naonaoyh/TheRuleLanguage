...
public class Rule_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_z0m96w_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createCollection_z0m96w_e0(editorContext, node));
    return editorCell;
  }

  private EditorCell createCollection_z0m96w_e0(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(editorContext, node);
    ...
    editorCell.addEditorCell(this.createRefNodeList_z0m96w_a4a(editorContext, node));
    return editorCell;
  }

  private EditorCell createConstant_z0m96w_a0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "\u5982\u679c");
  ...
  private EditorCell createConstant_z0m96w_d0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "\u5219");
    editorCell.setCellId("Constant_z0m96w_d0");
    editorCell.setDefaultText("");
    return editorCell;
  }

  private EditorCell createRefNodeList_z0m96w_a4a(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new Rule_Editor.actionListHandler_z0m96w_a4a(node, "action", editorContext);
  ...
  private static class actionListHandler_z0m96w_a4a extends RefNodeListHandler {
    public actionListHandler_z0m96w_a4a(SNode ownerNode, String childRole, EditorContext context) {
